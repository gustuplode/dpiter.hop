...
export const metadata = {
  title: "Gaming Products - Dpiter",
  description: "Browse our collection of gaming gear and accessories"
}
        ...
        <main>
          ...
          {error ? (
            <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
              <p className="text-lg text-slate-600 dark:text-slate-400">Unable to load gaming products</p>
                  ...
                  >
                    <div className="relative overflow-hidden rounded-lg bg-white dark:bg-slate-800 shadow-sm aspect-[3/4]">
                      ...
                      <div className="absolute bottom-2 left-2">
                        <span className="inline-flex items-center gap-1 rounded-md bg-purple-500/90 px-2 py-0.5 text-xs font-medium text-white">
                          Gaming
                        </span>
                      </div>
                    </div>
