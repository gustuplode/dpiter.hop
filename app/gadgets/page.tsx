...
export const metadata = {
  ...
  description: "Browse our collection of tech gadgets and accessories"
}
        ...
        <main>
          ...
          {error ? (
            <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
              <p className="text-lg text-slate-600 dark:text-slate-400">Unable to load gadgets</p>
                  ...
                  >
                    <div className="relative overflow-hidden rounded-lg bg-white dark:bg-slate-800 shadow-sm aspect-[3/4]">
                      ...
                      <div className="absolute bottom-2 left-2">
                        <span className="inline-flex items-center gap-1 rounded-md bg-blue-500/90 px-2 py-0.5 text-xs font-medium text-white">
                          Gadgets
                        </span>
                      </div>
                    </div>
            ...
            <div className="flex flex-col items-center justify-center py-16 px-4 text-center">
              <p className="text-lg text-slate-600 dark:text-slate-400">No gadgets available yet</p>
              <p className="text-sm text-slate-500 dark:text-slate-500 mt-2">
